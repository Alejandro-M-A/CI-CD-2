		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CI / CD",
									"targetURL": "#combttproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"combttproject1-display": {
								"semanticObject": "combttproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.btt.project1",
									"url": sap.ui.require.toUrl("com/btt/project1")
								}
							}
						}
					}
